...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have PixelBuilds_DEVICE-VERSION-DATE as format"
...
# Assume PixelBuilds_DEVICE-VERSION-DATE.zip
...
adb shell "killall org.pixelbuilds.updater 2>/dev/null"
adb shell "sqlite3 /data/data/org.pixelbuilds.updater/databases/updates.db" \
