...
import org.pixelbuilds.generatebp.GenerateBpPlugin
import org.pixelbuilds.generatebp.GenerateBpPluginExtension
import org.pixelbuilds.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("org.pixelbuilds:gradle-generatebp:+")
    }
}
...
android {
    ...
    defaultConfig {
        applicationId = "org.pixelbuilds.updater"
        minSdk = 30
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
