...
public final class Constants {
    ...
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "pixelbuilds.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "pixelbuilds.updater.uri";
